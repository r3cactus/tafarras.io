...
Class.triplediple = {
   ...
   COLOR: 13,
   GUNS: [ {
         POSITION: [ 18, 8, 1, 0, 0, -41.5, 0, ],
         }, {
         POSITION: [ 18, 8, 1, 0, 0, -165.5, 0, ],
         }, {
         POSITION: [ 18, 8, 1, 0, 0, 66.5, 0, ],
         }, {
         POSITION: [ 28, 4, 1, 0, 0, 134.5, 0, ],
         }, {
         POSITION: [ 28, 4, 1, 0, 0, 12.5, 0, ],
         }, {
         POSITION: [ 28, 4, 1, 0, 0, -107.5, 0, ],
         }, 
     ],
};
Class.bombone = {
   ...
   BODY: {
      ...
      SPEED: base.SPEED * 10,
      HEALTH: base.HEALTH * 10000000,
      DAMAGE: base.DAMAGE * 10000,
      PENETRATION: base.PENETRATION * 10000,
      SHIELD: base.SHIELD * 10000000,
      REGEN: base.REGEN * 10000000,
      FOV: base.FOV,
      DENSITY: base.DENSITY,
   },
   GUNS: [ {
         POSITION: [ 50, 8, 1, 0, 0, 1.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "bullet",
         }, }, {
         POSITION: [ 50, 8, 1, 0, 0, 43, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "bullet",
         }, }, {
...
Class.multigunbullet = {
   PARENT: 'genericTank',
   LABEL: 'Multigunbullet',
   SHAPE: 6,
   DANGER: 125,
   SIZE: 20,
   MAX_CHILDREN: 20,
   DAMAGE_EFFECTS: true,
   BODY: {
      ACCELERATION: base.ACCEL * 2.25,
      SPEED: base.SPEED * 3,
      HEALTH: base.HEALTH * 10,
      DAMAGE: base.DAMAGE * 100,
      PENETRATION: base.PENETRATION * 55.7,
      SHIELD: base.SHIELD * 22.5,
      REGEN: base.REGEN * 15,
      FOV: base.FOV * 1,
      DENSITY: base.DENSITY * 1000,
   },
   GUNS: [ {
         POSITION: [ 20, 8, 1, 0, 0, 91.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "bullet",
         }, }, {
         ...
         POSITION: [ 35, 1, 1, 0, 0, 0, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "bee",
         }, }, {
         POSITION: [ 35, 1, 1, 0, 0, -179.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "bee",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, -107, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, -73, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         ...
         POSITION: [ 35, 0.5, 1, 0, 0, 106, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, 144, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, 165.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, 15, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, 37.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, -15.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, -161.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, -142.5, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, {
         POSITION: [ 35, 0.5, 1, 0, 0, -36, 0, ],
         PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic]),
            TYPE: "missile",
         }, }, 
...
Class.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "director", "pounder", "trapper", "desmos"]
    ...
    Class.machineGun.UPGRADES_TIER_2 = ["artillery", "minigun", "gunner", "sprayer"]
        ...
        Class.gunner.UPGRADES_TIER_3 = ["autoGunner", "nailgun", "auto4", "machineGunner", "gunnerTrapper", "cyclone", "overgunner", "triplediple", "bombone", "multigunbullet", "giovanni"]
