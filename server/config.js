module.exports = {
    ...
    host: "https://github.com/r3cactus/tafarras.io",
    ...
    GAME_MODES: ['tdm', 'old_dreadnoughts'],
    ...
    FOOD_CAP_DODA: 12, // Max nest food per nest tile.
    FOOD_SPAWN_CHANCE_DODA: 0.5575, // Likeliness of nest food spawn attempts succeeding.
    FOOD_SPAWN_COOLDOWN_DODA: 45, // Cooldown (in game ticks) of nest food spawn attempts being made.
    ...
    FOOD_TYPES: [
        ...
        [0.0001, [
            [1000000, 'sphere'], [100000, 'cube'], [10000, 'tetrahedron'], [1000, 'octahedron'], [100, 'dodecahedron'], [10, 'icosahedron'], [1, 'tesseract']
        ]]
    ],
    ...
    FOOD_TYPES_NEST: [
        ...
        [0.01, [
            [1771561, 'sphere'], [161051, 'cube'], [14641, 'tetrahedron'], [1331, 'octahedron'], [121, 'dodecahedron'], [11, 'icosahedron'], [1, 'tesseract']
        ]],
    ],
